...
\linespread{1.1} % Línubil

%----------------------------------------------------
%-----------------------GALDRAR----------------------
%----------------------------------------------------

\definecolor{MyDarkGreen}{rgb}{0.0,0.4,0.0} %comments
\definecolor{myorange}{rgb}{1,0.8,0.75} %Linenumbers
...
\lstset{
        ...
        %\usefont{T1}{pcr}{m}{sl}\color{MyDarkGreen}\small, % Eitthvað sem eyðilaggði kommentin.
...
\begin{itemize}
\item[]\lstinputlisting[label=#1]{#1.cpp}
\end{itemize}
...
\newcommand{\inndr}{\setlength\itemindent{25pt}\item }
\newcommand{\svar}[1]{\\ \emph{Svar:} \underline{\underline{$#1$}}}
